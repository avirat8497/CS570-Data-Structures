    ...
    public class SlotMachineTests {
        ...
        private static void Test2()  {
            try {
                ...
                for (int i = 0; i < SlotMachine.Symbol.values().length; i++) {
        ...
        private static void Test3()  {
            try {
                ...
                SlotMachine sm = new SlotMachine(numReels, odds, wagerUnitValue);
                SlotMachine.Symbol[] symbols = new SlotMachine.Symbol[] { SlotMachine.Symbol.FLOWERS,
                        SlotMachine.Symbol.FLOWERS, SlotMachine.Symbol.BELLS, SlotMachine.Symbol.FRUITS, SlotMachine.Symbol.HEARTS};
        ...
        private static void Test4()  {
            try {
                ...
                SlotMachine sm = new SlotMachine(numReels, odds, wagerUnitValue);
                SlotMachine.Symbol[] symbols = new SlotMachine.Symbol[] { SlotMachine.Symbol.HEARTS,
                        SlotMachine.Symbol.FLOWERS, SlotMachine.Symbol.BELLS, SlotMachine.Symbol.BELLS, SlotMachine.Symbol.BELLS};
        ...
        private static void Test5()  {
            try {
                ...
                double [] odds = new double [] { 0.3, 0.2, 0.2, 0.2, 0.1 };
                SlotMachine sm = new SlotMachine(numReels, odds, wagerUnitValue);
                SlotMachine.Symbol[] symbols = new SlotMachine.Symbol[] { SlotMachine.Symbol.FRUITS,
                        SlotMachine.Symbol.FRUITS, SlotMachine.Symbol.FRUITS, SlotMachine.Symbol.FRUITS, SlotMachine.Symbol.FRUITS};
        ...
        private static void Test6()  {
            try {
                ...
                assert sm.getPayoutPercent() == 2 * SlotMachine.Symbol.SPADES.getPayoutFactor() * 100;
                passCnt++;
                score += 10;
                System.out.println("\nTest6 passed\n");
            } catch(Throwable t) {
        ...
        private static void Test7()  {
            try {
                ...
                double heartsPayoutFactor = SlotMachine.Symbol.HEARTS.getPayoutFactor();
                double spadesPayoutFactor = SlotMachine.Symbol.SPADES.getPayoutFactor();
